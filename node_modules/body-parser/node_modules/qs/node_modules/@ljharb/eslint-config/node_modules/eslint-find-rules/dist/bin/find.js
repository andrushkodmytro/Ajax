...
var argv = require('yargs').boolean(Object.keys(options)).alias(options).option('include', {
  alias: 'i',
  choices: ['deprecated'],
  type: 'string'
}).default('error', true).default('core', true).argv;
...
var ruleFinder = getRuleFinder(specifiedFile, finderOptions);
